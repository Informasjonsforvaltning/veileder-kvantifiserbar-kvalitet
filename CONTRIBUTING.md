# Veileder for beskrivelse av kvantifiserbar kvalitet
...
For at det følgende skal virke på din maskin, må du ha programvare installert:  
 ...
 Dersom du bruker Atom kan du gjøre som følger:  
  ...
  - I Clone from legger du inn følgende url `https://github.com/Informasjonsforvaltning/veileder-kvantifiserbar-kvalitet.git`

Alternativt i kommando-linje:
```
% git clone https://github.com/Informasjonsforvaltning/veileder-kvantifiserbar-kvalitet.git
% cd veileder-kvantifiserbar-kvalitet
...
Gå til https://github.com/Informasjonsforvaltning/veileder-kvantifiserbar-kvalitet/pulls og opprett `New pull request`
...
bash-5.0# asciidoctor-pdf -a lang=nb -D docs -o veileder-kvantifiserbar-kvalitet.pdf docs/main.adoc
```
