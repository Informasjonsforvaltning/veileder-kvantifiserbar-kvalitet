...
I henhold til https://data.norge.no/specification/spesifikasjon-for-beskrivelse-av-kvalitet-pa-datasett/[Spesifikasjon for beskrivelse av kvalitet på datasett &#x29C9;, window="_blank", role="ext-link"], er det flere ulike måter å beskrive kvalitet på et datasett på:
...
Veilederen må ses i sammenheng med  https://data.norge.no/specification/dqv-ap-no[DQV-AP-NO (Norsk applikasjonsprofil av DQV) &#x29C9;, window="_blank", role="ext-link"].

.Sammenheng mellom DCAT-AP-NO, DQV-AP-NO og felles definisjoner av kvalitets(del)dimensjoner og kvalitetsmål. 
image::images/sammenheng.png[alt="Tegning som viser sammenheng mellom DCAT-AP-NO (venstredelen av tegning), DQV-AP-NO (midtredelen tegningen) og Felles definisjoner (høyredelen av tegningen)."]

Tegningen ovenfor illustrerer sammenhengen mellom ulike standarder/spesifikasjoner og felles definisjoner:

* https://data.norge.no/specification/dcat-ap-no/["DCAT-AP-NO - Standard for beskrivelse av datasett, datatjenester og datakataloger &#x29C9;", window="_blank", role="ext-link"]: Denne spesifiserer bl.a. hvordan datasett beskrives, deriblant hvordan en beskrivelse av kvantifiserbar kvalitet knyttes til beskrivelsen av et datasett.

* https://data.norge.no/specification/dqv-ap-no[DQV-AP-NO - Norsk applikasjonsprofil av DQV &#x29C9;, window="_blank", role="ext-link"]: Denne spesifiserer hvordan kvalitet på datasett beskrives, bl.a. å knytte kvalitetsbeskrivelse til kvalitetsdimensjon.
